...
```yml
# Site settings
title: 废水先生 Blog             # title of your website
SEOTitle: Atom-tan          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: 废水先生     # modify this account to yours
weibo_username: 废水先生      # the footer woule be auto-updated.
